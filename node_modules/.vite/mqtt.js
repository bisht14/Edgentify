...
var yi = D((Fr) => {
  ...
  var BA = () => {
    ...
    var _a, _b2;
    return !!(typeof self == "object" && ((_b2 = (_a = self == null ? void 0 : self.constructor) == null ? void 0 : _a.name) == null ? void 0 : _b2.includes("WorkerGlobalScope")));
...
var _i = D((gr) => {
  ...
  var uT = (t, e) => {
    ...
    async function P(m) {
      if (!c || c.destroyed || !c.readable) return;
      let { data: v } = m;
